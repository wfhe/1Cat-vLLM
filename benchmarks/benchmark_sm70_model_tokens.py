...
def _sm70_turbomind_policy() -> dict[str, Any]:
    ...
    fp8_prefill_cached_dense = _env_bool(
        "VLLM_SM70_FP8_PREFILL_CACHED_DENSE",
        False,
    )
    ...
    return {
        ...
        "VLLM_SM70_FP8_PREFILL_CACHED_DENSE": os.environ.get(
            "VLLM_SM70_FP8_PREFILL_CACHED_DENSE"
        ),
        "fp8_prefill_cached_dense_effective": fp8_prefill_cached_dense,
